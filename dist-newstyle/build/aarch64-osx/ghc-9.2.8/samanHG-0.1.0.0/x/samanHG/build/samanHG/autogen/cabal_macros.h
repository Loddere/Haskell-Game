...
/* package samanHG-0.1.0.0 */
#ifndef VERSION_samanHG
#define VERSION_samanHG "0.1.0.0"
#endif /* VERSION_samanHG */
#ifndef MIN_VERSION_samanHG
#define MIN_VERSION_samanHG(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_samanHG */
...
#define CURRENT_COMPONENT_ID "samanHG-0.1.0.0-inplace-samanHG"
